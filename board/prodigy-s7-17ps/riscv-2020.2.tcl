...
# module references:
# $rocket_module_name, ethernet, sdc_controller, uart, ethernet_nexys_a7_100t
...
proc create_root_design { parentCell } {
  ...
  # assign_bd_address -offset 0x00000000 -range 0x08000000 -target_address_space [get_bd_addr_spaces RocketChip/MEM_AXI4] [get_bd_addr_segs DDR/mig_ddr4_0/memmap/memaddr] -force
