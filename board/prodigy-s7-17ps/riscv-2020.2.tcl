...
proc create_hier_cell_DDR { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 ddr4_sys_diff_clock
 ...
 # ] $mig_7series_0
  ...
  connect_bd_intf_net -intf_net C0_SYS_CLK_net [get_bd_intf_pins ddr4_sys_diff_clock] [get_bd_intf_pins mig_ddr4_0/C0_SYS_CLK]
  ...
  # connect_bd_net -net mem_mmcm_locked [get_bd_pins mem_reset_control_0/mmcm_locked] [get_bd_pins mig_ddr4_0/mmcm_locked]
  ...
  # connect_bd_net -net device_temp [get_bd_pins device_temp] [get_bd_pins mig_ddr4_0/device_temp_i]
...
proc create_root_design { parentCell } {
  ...
  set ddr4_sys_diff_clock [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 ddr4_sys_diff_clock ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net clock_ddr_200MHz [get_bd_intf_ports ddr4_sys_diff_clock] [get_bd_intf_pins DDR/ddr4_sys_diff_clock]
  ...
  assign_bd_address -offset 0x00000000 -range $addr_range -target_address_space [get_bd_addr_spaces RocketChip/MEM_AXI4] [get_bd_addr_segs DDR/mig_ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
